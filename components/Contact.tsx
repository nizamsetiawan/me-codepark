    ...
    <section id="contact" className="scroll-mt-16 lg:mt-16">
      ...
      <div className="flex flex-col gap-4 lg:px-6 mb-8">
        ...
        <p className="lg:text-lg lg:text-start text-muted-foreground">
          I&#39;m always eager to explore new opportunities and am open to messages. Whether you&#39;re interested in collaborating, have a question, or simply want to connect, feel free to reach out. I look forward to hearing from you!
        </p>
      </div>
      <div className="flex flex-row justify-center items-center gap-4 lg:px-6 mb-4">
        <a
          href="nizamsetiawan15.com"
          target="_blank"
